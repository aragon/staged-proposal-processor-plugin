...
[.contract]
[[Permissions]]
=== `++Permissions++` link:https://github.com/aragon/staged-proposal-processor-plugin/blob/1.0.0-alpha.1//Users/giorgilagidze/Desktop/work/multibody/staged-proposal-processor-plugin/src/libraries/Permissions.sol[{github-icon},role=heading-link]
