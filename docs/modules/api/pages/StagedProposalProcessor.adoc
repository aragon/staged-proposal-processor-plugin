...
=== `++StagedProposalProcessor++` link:https://github.com/aragon/staged-proposal-processor-plugin/blob/v1.1/src/StagedProposalProcessor.sol[{github-icon},role=heading-link]
...
=== `++StagedProposalProcessorSetup++` link:https://github.com/aragon/staged-proposal-processor-plugin/blob/v1.1/src/StagedProposalProcessorSetupZkSync.sol[{github-icon},role=heading-link]
...
[.contract]
[[SPPRuleCondition]]
=== `++SPPRuleCondition++` link:https://github.com/aragon/staged-proposal-processor-plugin/blob/v1.1/src/utils/SPPRuleCondition.sol[{github-icon},role=heading-link]
...
[.contract]
[[Permissions]]
=== `++Permissions++` link:https://github.com/aragon/staged-proposal-processor-plugin/blob/v1.1/src/libraries/Permissions.sol[{github-icon},role=heading-link]
